...
def config_eval_centroid_dataloader(args):
    ...
    if args.dataset == "dvs17m" or args.dataset == "oclrsyn":  
        ...
        val_data_dirs = ["/path/to/DAVIS2017/FlowImages_gap1/", 
                        ...
                        "/path/to/DAVIS2017/JPEGImages/480p/"] 
        val_seq = None
        val_dataset = DAVIS_dataset(
            data_dirs=val_data_dirs, seqs=val_seq, ref_sam=ref_sam, train = False,
            dataset=args.dataset, flow_gaps=flow_gaps
        )
...
def config_eval_dataloader(args):
    ...
    if args.dataset == "dvs17m" or args.dataset == "oclrsyn": 
        val_data_dirs = ["/path/to/DAVIS2017m/FlowImages_gap1/", 
                        ...
                        "/path/to/DAVIS2017m/JPEGImages/480p/"]
        val_seq = None
        val_dataset = DAVIS_eval_dataset(
            data_dirs=val_data_dirs, seqs=val_seq, ref_sam=ref_sam, 
        ...
        val_seq = None   
        val_dataset = YTVOS18m_eval_dataset(
            data_dirs=val_data_dirs, seqs=val_seq, ref_sam=ref_sam, 
            dataset=args.dataset, flow_gaps=flow_gaps, num_gridside=args.num_gridside
        )
        val_loader = DataLoader(
        ...
        val_data_dirs = ["/home/rutilea/personal/flowsam-playground/datasets/example_flow/", 
                        "/home/rutilea/personal/flowsam-playground/datasets/example_rgb/"]
        val_seq = ['person']
        val_dataset = Example_eval_dataset(
            data_dirs=val_data_dirs, seqs=val_seq, ref_sam=ref_sam, 
            dataset=args.dataset, flow_gaps=flow_gaps, num_gridside=args.num_gridside
        )
        val_loader = DataLoader(
